    ...
    <section class="products section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <h2 class="mb-5" style="color: red;">New Arrivals</h2>
                </div>

                <template v-for="(value, index) in newArrivals " :key="index">
                ...
                <div class="col-12">
                    <h2 class="mb-5" style="color: red;">All Products</h2>
                </div>
                <template v-for=" (value, index) in AllProducts " :key="index">
                    <div class="col-lg-4 col-12 mb-3">
                        <router-link :to="'/chi-tiet-san-pham/' + value.id + '-' + value.slug_san_pham">
                            <div class="product-thumb">
                                <a href="product-detail.html">
...
export default {
    ...
    methods: {
        viewHomePage() {
            baseRequest
                .get('trang-chu/san-pham/selectProduct')
                .then((res) => {
