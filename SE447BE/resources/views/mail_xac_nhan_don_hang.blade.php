...
<head>
    ...
    <title>Xác Nhận Đơn Đặt Hàng</title><!--[if (mso 16)]>
    <style type="text/css">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="https://cdn.printgo.vn/uploads/media/772948/thiet-ke-logo-shop-giay-18_1584095086.jpg"
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        Xác Nhận Đơn Đặt Hàng</h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                                    style="Margin:0;padding-bottom:20px;padding-top:5px;padding-right:40px;padding-left:40px">
                                                                    <p align="justify"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <span style="line-height:150% !important">Kính
                                                                            gửi Anh/Chị </span><strong
                                                                            style="line-height:150% !important">{{ $bien_1['ten_nguoi_nhan'] }}</strong><span
                                                                            style="line-height:150% !important">, Chúng
                                                                            tôi xin trân trọng thông báo rằng đơn hàng
                                                                            của Quý khách đã được giao thành công, số
                                                                            điện thoại nhận hàng </span><strong
                                                                            style="line-height:150% !important">{{ $bien_1['so_dien_thoai_nhan'] }}</strong><span
                                                                            style="line-height:150% !important"> đến
                                                                            địa chỉ </span><strong
                                                                            style="line-height:150% !important">{{ $bien_1['dia_chi_nhan_hang'] }}</strong><span
                                                                            style="line-height:150% !important">.</span><br>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-l"
                                                                    ...
                                                                    <h2 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:26px;font-style:normal;font-weight:bold;line-height:31px !important;color:#333333"
                                                                        align="center">THÔNG TIN ĐƠN HÀNG</h2>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="right"
                                                                                    ...
                                                                                    <p
                                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                                        <strong>{{ number_format($value['don_gia'], 2, '.', ',') . '$' }}</strong>
                                                                                    </p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="right" class="es-m-txt-r"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Tổng Tiền:
                                                                        <strong>{{ number_format($bien_1['tong_tien_thanh_toan'], 2, '.', ',') . '$' }}</strong>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                    ...
                                    <tr>
                                        <td class="es-m-p0r" valign="top" align="center"
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%"
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><a
                                                            target="_blank"
                                                            href="https://www.shutterstock.com/shutterstock/photos/1572613234/display_1500/stock-photo-picture-icon-no-image-symbol-picture-coming-soon-no-photo-available-1572613234.jpg"
                                                            style="mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:14px"><img
                                                                src="{{ $bien_1['link_qr_code'] }}"
                                                                alt="XXXXX-QRThanhToan"
                                                                style="display:block;font-size:12px;border:0;outline:none;text-decoration:none"
                                                                width="200" title="XXXXX-QRThanhToan"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p align="justify"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Nếu Quý Khách đã quét mã QR đơn hàng ở trên, vui
                                                                        lòng đợi xác thực từ bên cửa hàng trong thời
                                                                        gian ngắn.</p>
                                                                    <p align="justify"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Chúng tôi hy vọng rằng Quý khách sẽ thích thú
                                                                        với sản phẩm và dịch vụ của chúng tôi. Nếu có
                                                                        bất kỳ câu hỏi nào, Quý khách vui lòng liên hệ
                                                                        trực tiếp với chúng tôi thông qua cửa hàng giải
                                                                        đáp.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Chân thành cảm ơn Quý khách đã mua sắm tại cửa
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://fherhmw.stripocdn.email/content/guids/CABINET_1154ef987a3f887ce59a7fdb008c50d6/images/17971617974647919.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="45"></td>
                                                            </tr>
                                                    ...
                                                    <td class="es-m-p20b" align="center"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://fherhmw.stripocdn.email/content/guids/CABINET_1154ef987a3f887ce59a7fdb008c50d6/images/80801617974647921.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="45"></td>
                                                            </tr>
                                                    ...
                                                    <td align="center" class="es-m-p20b"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://fherhmw.stripocdn.email/content/guids/CABINET_1154ef987a3f887ce59a7fdb008c50d6/images/77861617974647919.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="45"></td>
                                                            </tr>
                                                    ...
                                                    <td align="center" style="padding:0;Margin:0;width:132px">
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        src="https://fherhmw.stripocdn.email/content/guids/CABINET_1154ef987a3f887ce59a7fdb008c50d6/images/59831617975283573.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="45"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <span>Copyright DZFullStack © 2024. All right
                                                                            reserved.</span>
                                                                    </p>
                                                                </td>
                                                            </tr>
